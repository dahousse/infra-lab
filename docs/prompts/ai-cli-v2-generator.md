...
OBJECTIF Générer un projet complet appelé ai-cli-v2 : CLI type kubectl pour interagir avec Ollama.
...
ARCHITECTURE tools/ai-cli-v2/ ├── ai ├── commands/ ├── core/ ├── utils/ ├── config/
...
IMPORTANT Le projet doit être directement exécutable après copie.
